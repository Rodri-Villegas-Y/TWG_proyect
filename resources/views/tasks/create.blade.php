...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Tarea Nueva</div>
                ...
                <div class="card-body">
                    ...
                    <form id="form" action="{{ route('task.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="max_date" class="form-control @error('max_date') is-invalid @enderror" required value="{{ old('max_date') }}">
                        @error('max_date') 
                        <div class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <i class="fas fa-database"></i> Guardar Tarea
                        </button>
                    </div>
